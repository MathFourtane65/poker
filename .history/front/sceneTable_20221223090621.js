...
class PokerTable extends Phaser.Scene {
    ...
    creerBoutons() {
        ...
        this.boutonMiser.on('pointerdown', () => {
            console.log('mise...');
            this.server.emit("bet", { seat: this.player.seat,username, amount: Number(this.print0.text) });
            this.updateDialogBubbleDealer(this.player.seat,username, Number(this.print0.text))
            this.cacherBoutons();
